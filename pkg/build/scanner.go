...
func Scanner(manifest model.Manifest, githubToken, git, branch string) error {
	...
	if err := util.CreatePR(manifest, "istio", "newBaseVersion"+buildTimestamp, "Update BASE_VERSION to "+buildTimestamp, trivyScanOutput, false, githubToken, git, branch); err != nil {
